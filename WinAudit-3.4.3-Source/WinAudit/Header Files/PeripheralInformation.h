...
class PeripheralInformation
{
 ...
 static void GetAuditRecords( TArray< AuditRecord >* pRecords );
    ...
    private:
        ...
        // Methods
 static void GetDisplayRecord( AuditRecord* pDisplayRecord );
 static void GetMappedDriveRecords( TArray<AuditRecord>* pMappedDriveRecords );
 static void GetKeyboardRecord( AuditRecord* pKeyboardRecord );
 static void GetMouseRecord( AuditRecord* pMouseRecord );
 static void GetNetworkRecord( AuditRecord* pNetworkRecord );
 static void GetPrinterRecords( TArray< AuditRecord >* pPrinterRecords );
