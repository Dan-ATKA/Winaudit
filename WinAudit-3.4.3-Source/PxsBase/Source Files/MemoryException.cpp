...
// Copy constructor
MemoryException::MemoryException( const MemoryException& oMemoryException )
                :MemoryException()
{
    *this = oMemoryException;
}
...
// Assignment operator
MemoryException& MemoryException::operator= ( const MemoryException& oMemoryException )
{
    if ( this == &oMemoryException ) return *this;

    // Base class
    Exception::operator= ( oMemoryException );
